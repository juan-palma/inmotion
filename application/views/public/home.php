...
<!-- 			<img src="<?php echo(base_url('assets/public/img/keep_on.svg')) ?>" alt="Keep on' moving" /> -->
			<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 327 218" xml:space="preserve" class="colDin1">
			<g>
			...
			<g>
				<path class="st0" d="M1.1,107.2c0-14.1,11.1-24.1,26.3-24.1s26.2,10,26.2,24.1s-11,24.1-26.2,24.1S1.1,121.2,1.1,107.2z
					 M39.5,107.2c0-8.1-5.2-12.9-12.2-12.9S15,99.2,15,107.2s5.3,12.9,12.3,12.9S39.5,115.2,39.5,107.2z"/>
			...
			<g>
				<path class="st0" d="M118,73.9c0-3.8,2.7-6.3,6.4-6.3s6.5,2.6,6.5,6.3c0,1.7-0.3,2.9-1.8,6.6l-3.9,9.4h-6.6l2.9-10.4
			...
			<g>
				...
				<path class="st0" d="M88.3,175.1c0-14.7,11.4-25.2,26.9-25.2c15.6,0,26.9,10.5,26.9,25.2s-11.3,25.2-26.9,25.2
					C99.7,200.3,88.3,189.8,88.3,175.1z M127.7,175.1c0-8.5-5.4-13.6-12.5-13.6s-12.6,5.1-12.6,13.6s5.5,13.6,12.6,13.6
				...
				<path class="st0" d="M267.4,171.5v28h-14.2v-25.9c0-7.9-3.6-11.6-9.9-11.6c-6.8,0-11.7,4.2-11.7,13.2v24.2h-14.2v-49H231v5.7
				...
				<path class="st0" d="M326.4,150.6v40.8c0,18.2-9.8,26.6-27.5,26.6c-9.3,0-18.3-2.3-24-6.7l5.6-10.2c4.2,3.4,11,5.6,17.3,5.6
					c10,0,14.4-4.6,14.4-13.4v-2.1c-3.7,4.1-9.1,6.1-15.5,6.1c-13.6,0-24.5-9.4-24.5-23.7s10.9-23.7,24.5-23.7c6.8,0,12.5,2.3,16.2,7
					v-6.3L326.4,150.6L326.4,150.6z M312.3,173.5c0-7.2-5.4-12-12.8-12s-12.9,4.8-12.9,12s5.5,12,12.9,12S312.3,180.7,312.3,173.5z"/>
			</g>
			</svg>
		</div>
		<div id="direccion">
			<span class="tel colDin1">T: <a class="colDin1" href="tel:<?php echo($generalDB->telefono); ?>"><?php echo($generalDB->telefono); ?></a></span>
			<span class="mail colDin1">M: <a class="colDin1" href="mailto:<?php echo($generalDB->correo); ?>"><?php echo($generalDB->correo); ?></a></span>
		</div>
	</div>
	<div class="mboxI"></div>
	<div class="mboxD"></div>
...
<section id="servicios" class="mboxG">
	<div class="mboxC">
		<h1 class="titulos colDin1"><?php echo($serviciosDB->titulo_general); ?></h1>
		<main class="row row-no-gutters">
			<div class="colorFondoBack"></div>
			<?php
...
<section id="clientes" class="mboxG">
	<div class="mboxC">
		<h1 class="titulos colDin1"><?php echo($clientesDB->titulo_general); ?></h1>
		<main class="row row-no-gutters">
			<div class="slideMain">
						...
						<div class="slideLine">
							...
							<?php
								foreach ($li as $lo) {
									?>
									<div class="logo">
										<img src="<?php echo( base_url('assets/public/img/clientes/'.$lo) ); ?>" />
									</div>
									<?php
								}
							?>
...
<section id="portafolios" class="mboxG">
	<div class="mboxC">
		<h1 class="titulos colDin1"><?php echo($portafoliosDB->titulo_general); ?></h1>
		<main class="">
			<?php
...
<section id="nosotros" class="mboxG">
	<div class="mboxC">
		<h1 class="titulos colDin1"><?php echo($nosotrosDB->titulo_general); ?></h1>
		<main class="row row-no-gutters">
			<div class="slideMain">
				<div class="slideItems">
				<?php
