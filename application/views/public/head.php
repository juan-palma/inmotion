...
<!-- 		<link rel="icon" href="favicon.ico?v1" /> -->
		...
		<title><?php echo($titulo); ?> | Sistema AMEX - DAM</title>
...
<!-- 		<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/latest/css/font-awesome.min.css" /> -->
	...
	<body itemscope="itemscope" itemtype="http://schema.org/WebPage" class="">
        ...
        <main id="primaryContainer">
			    <div class="wrapper">
			        <div class="sidebar" data-color="blue" data-image="<?php echo(base_url('assets/common/img/sideBack.jpg')); ?>"> <!-- imagen de la barra lateral del panel -->
			            <div class="sidebar-wrapper">
			                <div class="branding">
				                ...
				                <div class="side-ocultar">
					                <?php $img = (!empty($db->adminLogo)) ? 'assets/admin/img/'.$db->adminLogo : 'assets/common/img/logo_tagline_text.png'; ?>
									<img src="<?php echo(base_url($img)); ?>" />
				                </div>
			                </div>
			                ...
			                <div class="user">
			                    <div class="photo">
									<?php $img = (isset($_SESSION['userAvatar'])) ? 'assets/public/img/'.$_SESSION['userAvatar'] : 'assets/admin/img/avatar_default.svg'; ?>
			                        <img src="<?php echo(base_url($img)); ?>" />
			                    </div>
			                    <div class="info ">
			                        <a data-toggle="collapse" href="#collapseProfile" class="collapsed">
			                            <span><?php echo($_SESSION['lead_nombre'] /* . ' ' . $_SESSION['lead_apellidos'] */); ?>
			                            </span>
			                        </a>
			                    </div>
			                </div>
			                ...
			                <div class="saludoBox">
				                <h5 class="text">¡Hola!</h5>
				                <div class="saludo side-ocultar">
					                <h3 class="">
						                ¡Bienvenido!
					                </h3>
					                <h5>
			                ...
			                <ul class="nav">
				                <?php
					                ...
					                $modulos = (object)[];
					                $modulos->permiso_sub = '';
					                $modulos->permiso_modulo = 'Cargar_documentos';
					                
					                //$modulosB[] = $modulos;
					                
					                foreach($modulosB as $m){
						                $colaps = false;
						                if($m->permiso_sub !== ''){
			                        ...
			                        <ul class="navbar-nav">
			                            ...
			                            <li class="nav-item dropdown">
			                                ...
			                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
			                                    <a href="<? echo(base_url('inicio/out')); ?>" class="dropdown-item text-danger">
